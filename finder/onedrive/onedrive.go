...
const finderName = "onedrive_v1"
const baseUrl = "https://api.teamup.com"

type OneDriveFinder struct {
	ApiKey      string
	CalendarKey string
}

func (finder *OneDriveFinder) FinderName() string {
	return finderName
}

func (finder *OneDriveFinder) Find(query string) (*[]contracts.Result, error) {
